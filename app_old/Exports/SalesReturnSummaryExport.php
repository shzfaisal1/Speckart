...
class SalesReturnSummaryExport implements FromCollection, WithHeadings, WithStyles, ShouldQueue
{
    ...
    public function collection()
    {
        $query = DB::table('tbl_sales_product as sd')
            ...
            ->leftJoin('tbl_store as rst', 'rst.id', '=', 'sd.return_store')
            ->select(
                'st.store_name',
                's.sale_date',
                's.order_no',
