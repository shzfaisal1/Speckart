...
Route::get('/speckart-website', [\App\Http\Controllers\Website\WebSiteController::class, 'home'])->name('home');
...
Route::group(['middleware' => ['web']], function () {
    ...
    // AJAX Auth endpoints (for Login Modal Popup — no page redirect)
    ...
    Route::post('/address/{id}/delete',    [\App\Http\Controllers\Website\ProfileController::class, 'delete_address'])->name('address.delete');
