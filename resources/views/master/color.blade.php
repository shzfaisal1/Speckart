            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="domestic-orders-header">
                        <h3>Color Master</h3>
                        <input type="text" class="form-control input" placeholder="Search By,Color Name" id="search"  name="search" style="width:320px">
                        <a href="#" class=" btn" data-toggle="modal" data-target="#colorModal">
...
<div class="modal fade" data-backdrop="static" id="colorModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">color</h5>
                        ...
                        <div class="multisteps-form__content1">
                            ...
                            <div class="row">    
                                <div class="col-12">
                                    ...
                                    <input class="form-control"  placeholder="Enter color" id="color_name" name="color_name">
                                    <span class="error badge text-danger" id="color_nameError"></span>
                            ...
                            <div class="row">    
                                <div class="col-12">
                                    ...
                                    <input type="color" class="form-control"  placeholder="Enter color" id="color_code" name="color_code">
                                    <span class="error badge text-danger" id="color_codeError"></span>
...
{
   document.getElementById('modalTitle').innerText = 'color';
   $('#colorModal').modal('show');
}

function openEditModal(color) {
    var color = JSON.parse(decodeURIComponent(color));
    
    document.getElementById('color_name').value = color.color_name || '';
    document.getElementById('uid').value = color.color_id;
    $('#product_type').val(color.product_type).trigger('change');
    $('#colorModal').modal('show');
}
...
$("#colorForm").submit(function(e)
{
    ...
    let color_name = document.getElementById("color_name" + class_name).value.trim();
    let product_type = document.getElementById("product_type" + class_name).value.trim();
    let color_code = document.getElementById("color_code" + class_name).value.trim();


    if (color_name == '') {
        document.getElementById("color_nameError" + class_name).textContent = "Color name required.";
        document.getElementById("color_name" + class_name).classList.add("is-invalid");
        isValid = false;
    }
    ...
    if (color_code == '') {
        document.getElementById("color_codeError" + class_name).textContent = "Select COlor Code.";
        document.getElementById("color_code" + class_name).classList.add("is-invalid");
        isValid = false;
    }
            ...
            },
            {
                ...
                render: function(data, type, full) 
                {
                    return (`<div class="dropdown"><button type="button" class="btn dropdown-toggle" data-toggle="dropdown">ACTION</button><div class="dropdown-menu">`+
                                ...
                                `<a class="action-delete dropdown-item" href="#"  data-id="` + full['color_id'] + `">Delete</a>`+
                            `</div></div>`
                    );
                }    
            }
