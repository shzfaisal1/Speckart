            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="domestic-orders-header">
                        ...
                        <a href="#" class=" btn" data-toggle="modal" data-target="#sizeModal">
...
<div class="modal fade" data-backdrop="static" id="sizeModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">Size</h5>
                        ...
                        <div class="multisteps-form__content1">
                            ...
                            <div class="row">    
                                <div class="col-12">
                                    ...
                                    <input class="form-control"  placeholder="Enter size" id="size_name" name="size_name">
                                    <span class="error badge text-danger" id="size_nameError"></span>
...
function openEditModal(size) {
    var size = JSON.parse(decodeURIComponent(size));
    
    document.getElementById('size_name').value = size.size_name || '';
    document.getElementById('uid').value = size.size_id;
    $('#product_type').val(size.product_type).trigger('change');
    $('#sizeModal').modal('show');
}
...
$("#sizeForm").submit(function(e)
{
    ...
    let size_name = document.getElementById("size_name" + class_name).value.trim();
    let product_type = document.getElementById("product_type" + class_name).value.trim();


    if (size_name == '') {
        document.getElementById("size_nameError" + class_name).textContent = "Size name required.";
        document.getElementById("size_name" + class_name).classList.add("is-invalid");
        isValid = false;
    }
            ...
            },
            {
                ...
                render: function(data, type, full) 
                {
                    return (`<div class="dropdown"><button type="button" class="btn dropdown-toggle" data-toggle="dropdown">ACTION</button><div class="dropdown-menu">`+
                                ...
                                `<a class="action-delete dropdown-item" href="#"  data-id="` + full['size_id'] + `">Delete</a>`+
                            `</div></div>`
                    );
                }    
            }
