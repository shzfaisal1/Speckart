            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="domestic-orders-header">
                        ...
                        <a href="#" class=" btn" data-toggle="modal" data-target="#materialModal">
...
<div class="modal fade" data-backdrop="static" id="materialModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">Material</h5>
                        ...
                        <div class="multisteps-form__content1">
                            ...
                            <div class="row">    
                                <div class="col-12">
                                    ...
                                    <input class="form-control"  placeholder="Enter material" id="material_name" name="material_name">
                                    <span class="error badge text-danger" id="material_nameError"></span>
...
{
   document.getElementById('modalTitle').innerText = 'material';
   $('#materialModal').modal('show');
}

function openEditModal(material) {
    var material = JSON.parse(decodeURIComponent(material));
    
    document.getElementById('material_name').value = material.material_name || '';
    document.getElementById('uid').value = material.material_id;
    $('#product_type').val(material.product_type).trigger('change');
    $('#materialModal').modal('show');
}
...
$("#materialForm").submit(function(e)
{
    ...
    let material_name = document.getElementById("material_name" + class_name).value.trim();
    let product_type = document.getElementById("product_type" + class_name).value.trim();


    if (material_name == '') {
        document.getElementById("material_nameError" + class_name).textContent = "material name required.";
        document.getElementById("material_name" + class_name).classList.add("is-invalid");
        isValid = false;
    }
    ...
    let form = $("#materialForm")[0];
    let data = new FormData(form);

    $.ajax({
        type: 'POST',
        url: "{{ route('admin.material-stored') }}",
        data: data,
        dataType: "JSON",
        processData: false,
        contentType: false,
            ...
            },
            {
                ...
                render: function(data, type, full) 
                {
                    return (`<div class="dropdown"><button type="button" class="btn dropdown-toggle" data-toggle="dropdown">ACTION</button><div class="dropdown-menu">`+
                                ...
                                `<a class="action-delete dropdown-item" href="#"  data-id="` + full['material_id'] + `">Delete</a>`+
                            `</div></div>`
                    );
                }    
            }
