    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">Add New Frame</h5>
                        ...
                        <div class="multisteps-form__content1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control"  placeholder="Enter Product Name" id="product_name" name="product_name">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Shape" name="Shape" id="Shape">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Material" name="Material" id="Material">
...
{
    document.getElementById('modalTitle').innerText = 'Add New Frame';
    document.getElementById('productForm').action = '{{ route('admin.frameproduct.store') }}';
...
{
    var frame = JSON.parse(decodeURIComponent(frame));
    
    document.getElementById('modalTitle').innerText = 'Edit Frame Product';
    document.getElementById('productForm').action = `{{ url('/frameproduct/` + frame.id + `') }}`;
    document.getElementById('formMethod').value = 'PUT';
    document.getElementById('Purchase_Base_Price').value = frame.Purchase_Base_Price || '';
    document.getElementById('Purchase_Price').value = frame.Purchase_Price || '';
    document.getElementById('Retail_Price').value = frame.Retail_Price || '';
    document.getElementById('BB_Price').value = frame.BB_Price || '';
    document.querySelector(`input[name="Track_Inventory"][value="${frame.Track_Inventory}"]`).checked = true;
    document.querySelector(`input[name="Allow_Negative_Inventory"][value="${frame.Allow_Negative_Inventory}"]`).checked = true;
    document.getElementById('uid').value = frame.id;
    document.getElementById('product_id').value = frame.product_id;
    if (document.getElementById('product_code')) document.getElementById('product_code').value = frame.product_code || '';
    if (document.getElementById('product_name')) document.getElementById('product_name').value = frame.product_name || '';
    if (document.getElementById('Company')) document.getElementById('Company').value = frame.Company || '';
    if (document.getElementById('Quality')) document.getElementById('Quality').value = frame.Quality || '';
    if (document.getElementById('Color')) document.getElementById('Color').value = frame.Color || '';
    if (document.getElementById('Size')) document.getElementById('Size').value = frame.Size || '';
    if (document.getElementById('Type')) document.getElementById('Type').value = frame.Type || '';
    if (document.getElementById('Gender')) document.getElementById('Gender').value = frame.Gender || '';
    if (document.getElementById('Shape')) document.getElementById('Shape').value = frame.Shape || '';
    if (document.getElementById('Material')) document.getElementById('Material').value = frame.Material || '';
    if (document.getElementById('Temple_Detail')) document.getElementById('Temple_Detail').value = frame.Temple_Detail || '';
    if (document.getElementById('Bridge_Size')) document.getElementById('Bridge_Size').value = frame.Bridge_Size || '';
    if (document.getElementById('Description')) document.getElementById('Description').value = frame.Description || '';
    
    try {
        var images = JSON.parse(frame.product_image);
        var gallery = document.getElementById('product_image_gallery');
        gallery.innerHTML = ''; 
    
        if (Array.isArray(images) && images.length > 0) {
            images.forEach(function(imageName) {
                var imagePath = `/public/uploads/frame/product/${frame.product_id}/${imageName}`;
    ...
    if (frame.main_image) {
        var mainImagePath = `/public/uploads/frame/product/${frame.product_id}/${frame.main_image}`;
...
let dataListView = $('.datatables-basic')
    ...
    .on('draw.dt', function() 
    {
      $('#processingLoader').hide();
        ...
        "bFilter": false,
        "ajax": {
            url: "{{ route('admin.frameproduct.search') }}",
            "dataType": "json",
            "type": "POST",
            "data": function(d) 
            {
    ...
    $("table").delegate(".action-delete", "click", function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ url('/frameproduct') }}" + '/' + id + '/destroy',
                        type: "POST",
                        data: {
                            _token: "{{ csrf_token() }}"
                        },
