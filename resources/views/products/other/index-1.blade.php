...
@endsection
@section('content')
@php $tbl_setting =  DB::table("tbl_product_code_setting")->where('product_type','Other')->first();   @endphp
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">Add New Other Product</h5>
                        ...
                        <div class="multisteps-form__content1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control"  placeholder="Enter Color" id="Color" name="Color">
                               ...
                               @if($tbl_setting->type == '0')
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control"  placeholder="Enter Typoe" id="otherType" name="otherType">
                                    <span class="error badge text-danger" id="otherTypeError"></span>
                                </div>
                                @endif
                                @if($tbl_setting->Shape == '0')
                                <div class="col-md-4">
                                    <label for="">Shape </label>
                                    <input class="form-control"  placeholder="Enter Shape" id="Shape" name="Shape">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control"  placeholder="Enter Size" id="Size" name="Size">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control"  placeholder="Enter Material" id="Material" name="Material">
...
{
    document.getElementById('modalTitle').innerText = 'Add New Other Product';
    document.getElementById('productForm').action = '{{ route('admin.otherproduct.store') }}';
    document.getElementById('formMethod').value = 'POST';
    document.getElementById('productForm').reset();
    $('#productModal').modal('show');
}

function openEditModal(other) {
    var other = JSON.parse(decodeURIComponent(other));
    document.getElementById('modalTitle').innerText = 'Edit other Product';
    document.getElementById('productForm').action = `{{ url('/otherproduct/` + other.id + `') }}`;
    document.getElementById('formMethod').value = 'PUT';
    
    document.getElementById('Purchase_Base_Price').value = other.Purchase_Base_Price;
    document.getElementById('Purchase_Price').value = other.Purchase_Price;
    document.getElementById('Retail_Price').value = other.Retail_Price;
    document.getElementById('BB_Price').value = other.BB_Price;
    document.querySelector(`input[name="Track_Inventory"][value="${other.Track_Inventory}"]`).checked = true;
    document.querySelector(`input[name="Allow_Negative_Inventory"][value="${other.Allow_Negative_Inventory}"]`).checked = true;
    document.getElementById('uid').value = other.id;
    document.getElementById('product_id').value = other.product_id;
    

    
    if (document.getElementById('product_code')) document.getElementById('product_code').value = other.product_code || '';
    if (document.getElementById('product_name')) document.getElementById('product_name').value = other.product_name || '';
    if (document.getElementById('Company')) document.getElementById('Company').value = other.Company || '';
    if (document.getElementById('Quality')) document.getElementById('Quality').value = other.Quality || '';
    if (document.getElementById('Color')) document.getElementById('Color').value = other.Color || '';
    if (document.getElementById('Shape')) document.getElementById('Shape').value = other.Shape || '';
    if (document.getElementById('Size')) document.getElementById('Size').value = other.Size || '';
    if (document.getElementById('Type')) document.getElementById('Type').value = other.Type || '';
    if (document.getElementById('Material')) document.getElementById('Material').value = other.Material || '';
    if (document.getElementById('Description')) document.getElementById('Description').value = other.Description || '';

    try {
        var images = JSON.parse(other.product_image);
        ...
        if (Array.isArray(images) && images.length > 0) {
            images.forEach(function(imageName) {
                var imagePath = `/public/uploads/other/product/${other.product_id}/${imageName}`;
    ...
    if (other.main_image) {
        var mainImagePath = `/public/uploads/other/product/${other.product_id}/${other.main_image}`;
...
let dataListView = $('.datatables-basic')
    ...
    .on('draw.dt', function() 
    {
      $('#processingLoader').hide();
        ...
        "bFilter": false,
        "ajax": {
            url: "{{ route('admin.otherproduct.search') }}",
            "dataType": "json",
            "type": "POST",
            "data": function(d) 
            {
    ...
    $("table").delegate(".action-delete", "click", function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ url('/otherproduct') }}" + '/' + id + '/destroy',
                        type: "POST",
                        data: {
                            _token: "{{ csrf_token() }}"
                        },
