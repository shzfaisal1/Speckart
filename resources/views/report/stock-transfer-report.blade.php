    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-3" style="margin-top:10px">
                     <div class="form-group">
                        <select class="form-control select" style="height: 32px !important;margin-top:10px" id="from_store" name="from_store">
                ...
                <div class="col-lg-3" style="margin-top:10px">
                     <div class="form-group">
                        <select class="form-control select" style="height: 32px !important;margin-top:10px" id="to_store" name="to_store">
...
function get_transferdata()
{
    ...
    $.ajax({
	   type: "POST",
	   url: "{{ route('admin.get-transferdata-report') }}",
	   data: {
	   ...
	   success: function (success)  
	   {
		    ...
		    $('#transferdataload').empty();
		    if (success.status === 'success') 
            {
                $('#transferdataload').show();
                $('#transferdataload').append(main_data);
...
let dataListView = $('.datatables-basic')
    ...
    .on('draw.dt', function() 
    {
      $('#processingLoader').hide();
        ...
        "bFilter": false,
        "ajax": {
            url: "{{ route('admin.transferstock-report-datatable') }}",
            "dataType": "json",
            "type": "POST",
            "data": function(d) 
            {
...
<script>
        $('#bulkexport').on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.transfer-excel-download') }}",
                data: {
                   product_type: $('#product_type').val(),
        	       date_from: $('#date_from').val(),
        	       date_to: $('#date_to').val(),
