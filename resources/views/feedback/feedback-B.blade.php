            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="domestic-orders-header">
                        <h3>6 Month Later Sales Feedback Dashboard</h3>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="feedback_status_b" id="inlineRadio8" value="Not Connected" checked>
                          <label class="form-check-label" for="inlineRadio8">Not Connected</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="feedback_status_b" id="inlineRadio9" value="Connected">
                          <label class="form-check-label" for="inlineRadio9">Connected</label>
                        </div>
						<div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="feedback_status_b" id="inlineRadio10" value="Ringing">
                          <label class="form-check-label" for="inlineRadio10">Ringing</label>
                        </div>
						<div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="feedback_status_b" id="inlineRadio11" value="Followup">
                    ...
                    <div class="col-md-9">
                            ...
                            <input type="hidden"
                                   ...
                                   name="feedback_b_datetime">
                            <br>
                          <textarea class="form-control" type="input" placeholder="Enter Feedback" name="feedback_b" id="feedback_b" ></textarea>
                          <strong id="feedback_bError"></strong>
                    </div>    
...
let dataListView = $('.datatables-basic')
    ...
    function openfeedbackModal(id,product_code,description,ptype,oid)
   {
    ...
    function updatedFeedback()
    {
        ...
        let uid            = $("#uid").val();
        let feedback_status_b  = $("input[name='feedback_status_b']:checked").val();
        let feedback_b  = $("#feedback_b").val().trim();
        let feedback_b_datetime  = $("#audit_date_display").val();
        ...
        if(feedback_b === '')
        {
            $("#feedback_bError").text("Feedback required");
            return;
        }
        ...
        $.ajax({
            ...
            data: {
                ftype: 'sixmonth',
                uid: uid,
                feedback_status_b: feedback_status_b,
                feedback_b: feedback_b,
                feedback_b_datetime: feedback_b_datetime,
                _token: "{{ csrf_token() }}"
            },
