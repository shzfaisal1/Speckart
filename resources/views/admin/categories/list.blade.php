        ...
        <div class="modal-content">
            ...
            <form id="categoryForm" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="form-label fw-medium d-block">Allowed Filters on Catalog</label>
                        <div class="row">
                            @foreach([
                                'frame_type' => 'Frame Type',
                                'shape' => 'Frame Shape',
                                'color' => 'Lens/Frame Color',
                                'brand' => 'Brands',
                                'size' => 'Size',
                                'material' => 'Material',
                                'age' => 'Age Group',
                                ...
                                'modality' => 'Disposability (Modality)',
                                'polarized' => 'Polarized',
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input filter-checkbox-admin" type="checkbox" name="allowed_filters[]" value="{{ $key }}" id="filter_{{ $key }}">
                                        <label class="form-check-label" for="filter_{{ $key }}" style="font-size: 13px; font-weight: normal; cursor: pointer; padding-left: 5px;">{{ $label }}</label>
                                    </div>
                                </div>
                            @endforeach
                        </div>
...
$(document).ready(function () {
    ...
    $(document).on('click', '.btn-edit-category', function () {
        ...
        $.get(`${baseUrl}/${id}/edit`, function (data) {
            ...
            // Clear and prefill allowed filters checkboxes
            $('.filter-checkbox-admin').prop('checked', false);
            if (data.allowed_filters) {
                var filters = Array.isArray(data.allowed_filters) ? data.allowed_filters : JSON.parse(data.allowed_filters);
