                        ...
                        <div class="col-md-12">
                             <div class="row">
                                 <div class="col-md-12 d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <span id="cust_type_badge" class="badge bg-secondary" style="font-size:13px;padding:6px 12px;display:none;"></span>
                                 </div> 
                                 <input type="hidden" name="cust_type" id="cust_type" value="B2C">
                                 <div class="col-md-3">
                                 ...
                                 <div class="col-md-3 b2b-field" style="display:none">
                                     <label for="" class="form-label">Company Name: </label>
                                     <input type="text" class="form-control" placeholder="Enter Company Name" id="company_name" name="company_name" readonly>
                                 </div>
                                 <div class="col-md-3 b2b-field" style="display:none">
                                     <label for="" class="form-label">GSTIN: </label>
                                     <input type="text" class="form-control" placeholder="GST No" id="gst_no" name="gst_no" readonly>
                                 </div></div>
                                <div class="col-md-3">
                                                ...
                                                <table class="table table-sm mb-0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td colspan="4" style="width: 70%;">
                                                            ...
                                                            {{-- ===== BOGO / B2B MEMBERSHIP BANNER ===== --}}
                                                            <div class="row mt-2" id="bogo_banner" style="display:none">
                                                                <div class="col-md-12">
                                                                    <div id="b2b_notice_banner" style="display:none;background:#6c5ce7;color:#fff;padding:10px 16px;border-radius:10px;font-weight:600;">
                                                                        🏢 <strong>B2B Wholesale Customer Order</strong> — <span id="b2b_company_display"></span> (GSTIN: <span id="b2b_gst_display">N/A</span>). Retail BOGO & Loyalty Points are excluded.
                                                                    </div>
                                                                    <div id="bogo_active_banner" style="display:none;background:linear-gradient(135deg,#00b894,#00cec9);color:#fff;padding:10px 16px;border-radius:10px;font-weight:600;">
                                                                        🛍 <span id="bogo_card_name"></span> Active — <strong>Buy 1 Get 1 Free Applied!</strong>
                                                                        <small style="opacity:0.85;"> Cheapest eligible item is FREE</small>
                                                                    </div>
                                                                    <div id="bogo_expired_banner" style="display:none;background:#fdcb6e;color:#2d3436;padding:10px 16px;border-radius:10px;font-weight:600;">
                                                                        ⚠️ Membership Expired — BOGO not applicable
                                                                    </div>
                                                                    <div id="bogo_none_banner" style="display:none;background:#dfe6e9;color:#636e72;padding:10px 16px;border-radius:10px;">
                                                                        ℹ️ No active Membership for this customer
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <br>
                                                        ...
                                                        <td colspan="2">
                                                            <table class="table table-borderless table-sm mb-0 w-100">
                                                                ...
                                                                <tr id="bogo_discount_row" style="display:none">
                                                                    <td class="text-end" style="color:#00b894;font-weight:600;">🛍 BOGO Discount : Rs</td>
                                                                    <td>
                                                                        <input type="text" class="form-control form-control-sm text-end" id="bogo_discount_display" value="0.00" readonly style="color:#00b894;font-weight:600;">
                                                                        <input type="hidden" name="bogo_discount" id="bogo_discount" value="0">
                                                                    </td>
                                                                </tr>
                                                                <tr>
