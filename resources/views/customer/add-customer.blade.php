                    ...
                    <div class="row">
                         <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="cust_type" id="inlineRadio1" value="B2B">
                                  <label class="form-check-label" for="inlineRadio1">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="cust_type" id="inlineRadio2" value="B2C" checked>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter address" name="cust_address" id="cust_address">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control" placeholder="Customer Notes" name="cust_note" id="cust_note">
...
<script>
   ...
   $("#customerForm").submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ route('admin.customer-stored') }}",
            data: data,
            dataType: "JSON",
            processData: false,
            contentType: false,
