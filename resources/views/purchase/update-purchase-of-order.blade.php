        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="domestic-orders-header">
                    <h3>Update Purchase Details of Sale Order</h3>
                </div>
            </div>
        </div>
        <div class="row">
                                   ...
                                   <tbody>
                                    @foreach($saleproduct as $product)
                                        ...
                                        @php
                                            ...
                                            {
                                                if($product->right_glass == NULL)
                                                {
                                                    $product_deatils = $product->left_glass;
                                                }
                                                else
                                                {
                                                    $product_deatils = $product->right_glass;
                                                }
                                            }
                                            else
                                            {
                                                $product_deatils = $product->product_deatils;
                                            }
                                    
                                            $tbl_sale = DB::table('tbl_sales')
...
$("#purchaseForm").submit(function (e) {
    ...
    $.ajax({
        ...
        url: "{{ route('admin.add-purchase-to-pending-sale') }}",
