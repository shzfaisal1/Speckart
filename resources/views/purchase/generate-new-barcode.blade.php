            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        <input type="text" class="form-control input" placeholder="Challan No,Purchase Bill no,Product Code" id="search" name="search" style="width: 250px;margin-top: 10px;">
                    </div>
                </div> 
                    ...
                    <table class="table datatables-basic w-100">
                        <thead>
                            <div class="row justify-content-between align-items-center mb-3 mt-3 mr-3">
                                ...
                                <div class="col-md-2">
                                     <span id="bulk_action" class="btn btn-success">Generate Barcode Number</span>
                                   
                                </div>
                            </div>
                            <tr>
                                <th colspan="7" style="color: #FF0000;" colspan="2">Select checkbox and click on "Generate Barcode" </td>
                            </tr>
                            <tr>
                                ...
                                <th class="wd-15p">Purchase/Challan/Import/Inventory Details</th>
...
let dataListView = $('.datatables-basic')
    ...
    .on('draw.dt', function() 
    {
      $('#processingLoader').hide();
        ...
        "bFilter": false,
        "ajax": {
            url: "{{ route('admin.new-barcode-datatable') }}",
            "dataType": "json",
            "type": "POST",
            "data": function(d) 
            {
