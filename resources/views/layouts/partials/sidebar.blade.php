...
<aside class="app-sidebar comb-sidebar">
    ...
    <ul class="side-menu">
        ...
        {{-- ==================== B2C Product Catalog (NEW) ==================== --}}
        @if ($usr->can('B2C-Catalog') || $usr->can('B2C-Catalog-List') || $usr->can('B2C-Catalog-Create'))
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="#">
                <img src="{{ asset('/assets/images/speckart-Icons/Dashboard.png') }}" class="avatar-xl mb-1">
            ...
            <ul class="slide-menu">
                @if ($usr->can('B2C-Catalog-List') || $usr->can('B2C-Catalog'))
                <li><a href="{{ route('admin.catalog.index') }}" class="slide-item">All Products</a></li>
                @endif
                @if ($usr->can('B2C-Catalog-Create') || $usr->can('B2C-Catalog'))
        ...
        {{-- ==================== B2C Online Orders (NEW) ==================== --}}
        @if ($usr->can('B2C-Orders') || $usr->can('B2C-Orders-List') || $usr->can('B2C-Shipping-Charges'))
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="#">
            ...
            <ul class="slide-menu">
                @if ($usr->can('B2C-Orders-List') || $usr->can('B2C-Orders'))
                <li><a href="{{ route('admin.b2c-orders.index') }}" class="slide-item">All Orders</a></li>
                @endif
                @if ($usr->can('B2C-Shipping-Charges') || $usr->can('B2C-Orders'))
        ...
        {{-- ==================== Lens System (NEW) ==================== --}}
        @if ($usr->can('Lens-System') || $usr->can('Lens-Packages') || $usr->can('Lens-Benefits') || $usr->can('Lens-Tags'))
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="#">
                <img src="{{ asset('/assets/images/speckart-Icons/Dashboard.png') }}" class="avatar-xl mb-1">
        ...
        @if ($usr->can('Offers') || $usr->can('Offers-Create') || $usr->can('Offers-List') || $usr->can('Gift-Vouchers'))
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="#">
                <img src="{{ asset('/assets/images/speckart-Icons/Dashboard.png') }}" class="avatar-xl mb-1">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="#">
                ...
                <span class="side-menu__label">Purchase</span><i class="angle fa fa-angle-right"></i>
            </a>
            <ul class="slide-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="#">
                ...
                <span class="side-menu__label">Inventory</span><i class="angle fa fa-angle-right"></i>
            </a>
            <ul class="slide-menu">
        ...
        || $usr->can('Sales-Pending-History') || $usr->can('Sales-Return-Request-List') || $usr->can('Sales-Gatepass') || $usr->can('Sales-Handover-History'))
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="#">
                <img src="{{ asset('/assets/images/speckart-Icons/NDR.png') }}" class="avatar-xl mb-1">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a href="{{route('admin.feedback-dashboard-A')}}" class="slide-item">2 Days Later Dashboard</a></li>
                @endif
                @if ($usr->can('Feedback-dashboard-B'))
                <li><a href="{{route('admin.feedback-dashboard-B')}}" class="slide-item">6 Month Later Dashboard</a></li>
                @endif
            </ul>
        </li>
        @endif
