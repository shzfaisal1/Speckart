        ...
        <div class="row justify-content-center g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-lg h-100 text-center p-4 position-relative" style="border-radius:20px; overflow:hidden; border:2px solid #fdcb6e; background:#fff;">
                    ...
                    <div class="mt-auto">
                        <form action="{{ route('cart.add_membership') }}" method="POST">
                            @csrf
                            <input type="hidden" name="card_id" value="{{ $card->card_id }}">
                            <button type="submit" class="btn btn-primary btn-block w-100 py-3 font-weight-bold shadow-sm" style="border-radius:30px; font-size:16px; background:#6c5ce7; border:none; color: #fff;">
                                Get {{ $card->card_name }}
                            </button>
                        </form>
                    </div>
