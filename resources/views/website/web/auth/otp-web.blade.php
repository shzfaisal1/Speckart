                    ...
                    <div class="login-sec-left1">
                        <div class="login-sec-left">
                            <div class="login-sec-left-heading">
                                <h4>Enter</h4>
                                <h3>Your OTP !</h3>
                                <p>Please enter the one-time password (OTP) that was sent to your mobile number via SMS
                                </p>
                            </div>
                            @if(isset($success))
                            ...
                            <form action="{{ route('otp.web.post') }}" method="POST">
                                ...
                                <a href="{{ route('login.web') }}" class="resend" style="position: absolute">Resend OTP</a>
