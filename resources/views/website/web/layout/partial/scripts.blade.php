...
(function () {
    ...
    window.speckartToggleWishlist = function (productId, buttonEl) {
        if (!isLoggedIn) {
            ...
            var modal = new bootstrap.Modal(document.getElementById('speckartLoginModal'));
            modal.show();
            return;
        }
    ...
    // ── After Login Success → Save Pending Wishlist ───
    window.addEventListener('speckartLoginSuccess', function () {
        ...
        if (pending) {
            ...
            // Find the heart button for this product and trigger toggle
