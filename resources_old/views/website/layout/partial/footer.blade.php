        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-brand">
                    <img src="{{ asset('website/assets/img/logo/Specskart-logo-png.png') }}" alt="Specskart" class="footer-logo">
                    ...
                    <div class="footer-social">
                        <a href="#"><img src="{{ asset('website/assets/img/icon/fb.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('website/assets/img/icon/insta.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('website/assets/img/icon/twiter.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('website/assets/img/icon/in.png') }}" alt=""></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="footer-apps mt-4">
                    <a href="#">
                        <img src="{{ asset('website/assets/img/logo/app-store.png') }}" alt="App Store">
                    </a>

                    <a href="#">
                        <img src="{{ asset('website/assets/img/logo/play-store.png') }}" alt="Play Store">
                    </a>
                </div>
            </div>
