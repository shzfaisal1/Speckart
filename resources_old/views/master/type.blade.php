            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="domestic-orders-header">
                        ...
                        <a href="#" class=" btn" data-toggle="modal" data-target="#typeModal">
...
<div class="modal fade" data-backdrop="static" id="typeModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">Type</h5>
                        ...
                        <div class="multisteps-form__content1">
                            ...
                            <div class="row">    
                                <div class="col-12">
                                    ...
                                    <input class="form-control"  placeholder="Enter type" id="type_name" name="type_name">
                                    <span class="error badge text-danger" id="type_nameError"></span>
                                </div>
...
function openEditModal(type) {
    ...
    document.getElementById('uid').value = type.type_id;
    document.getElementById('imageStar').style.display = 'none';
    document.getElementById('image').value = '';
    $('#product_type').val(type.product_type).trigger('change');
    $('#typeModal').modal('show');
}
...
$("#typeForm").submit(function(e)
{
    ...
    let type_name = document.getElementById("type_name" + class_name).value.trim();
    // let product_type = document.getElementById("product_type" + class_name).value.trim();


    if (type_name == '') {
        document.getElementById("type_nameError" + class_name).textContent = "type name required.";
        document.getElementById("type_name" + class_name).classList.add("is-invalid");
        isValid = false;
    }
            ...
            },
            {
                ...
                render: function(data, type, full) 
                {
                    return (`<div class="dropdown"><button type="button" class="btn dropdown-toggle" data-toggle="dropdown">ACTION</button><div class="dropdown-menu">`+
                                ...
                                `<a class="action-delete dropdown-item" href="#"  data-id="` + full['type_id'] + `">Delete</a>`+
                            `</div></div>`
                    );
                }    
            }
