            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="domestic-orders-header">
                        ...
                        <a href="#" class=" btn" data-toggle="modal" data-target="#indexModal">
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">Index</h5>
                ...
                <form id="indexForm" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="multisteps-form__content">
                        <div class="multisteps-form__content1">
                            ...
                            <div class="row">    
                                <div class="col-12">
                                    <label for="">Index <span class="text-danger">*</span></label>
                                    <input class="form-control"  placeholder="Enter index" id="index_name" name="index_name">
                                    <span class="error badge text-danger" id="index_nameError"></span>
...
{
   document.getElementById('modalTitle').innerText = 'Index';
   $('#indexModal').modal('show');
}

function openEditModal(index) {
    var index = JSON.parse(decodeURIComponent(index));
    
    document.getElementById('index_name').value = index.index_name || '';
    document.getElementById('uid').value = index.index_id;
    $('#product_type').val(index.product_type).trigger('change');
    $('#indexModal').modal('show');
}
...
$("#indexForm").submit(function(e)
{
    ...
    let index_name = document.getElementById("index_name" + class_name).value.trim();
    let product_type = document.getElementById("product_type" + class_name).value.trim();


    if (index_name == '') {
        document.getElementById("index_nameError" + class_name).textContent = "index name required.";
        document.getElementById("index_name" + class_name).classList.add("is-invalid");
        isValid = false;
    }
            ...
            },
            {
                ...
                render: function(data, type, full) 
                {
                    return (`<div class="dropdown"><button type="button" class="btn dropdown-toggle" data-toggle="dropdown">ACTION</button><div class="dropdown-menu">`+
                                ...
                                `<a class="action-delete dropdown-item" href="#"  data-id="` + full['index_id'] + `">Delete</a>`+
                            `</div></div>`
                    );
                }    
            }
