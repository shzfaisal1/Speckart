...
class PurchaseReturnSummaryExport implements FromCollection, WithHeadings, WithStyles, ShouldQueue
{
    ...
    public function collection()
    {
        $query = DB::table('tbl_purchase_deatils as pd') // ✅ fixed typo: "deatils" → "details"
            ...
            ->select('pd.*', 'p.supplier_name', 'p.purchase_date')->where('pd.p_status', '1');
